...
/**
 * Represents an observable game state that will be used to facilitate View-Model bindings in our MVC
 *
 * @author Marvin Chedid (302446)
 * @author Johnny Borkhoche (296169)
 */
public final class ObservableGameStateOriginal extends ObservableGameState {
     ...
     */
    public ObservableGameStateOriginal(PlayerId newPlayerId) {
    ...
    /**
     * This method returns a property containing Player_3's card count
     *
     * @return a property containing Player_3's card count
     */
